...
class ArticleController extends BaseController {
    ...
    public function index(){
        global $setting;
        $this->pagesize = $setting['sysset']['page_article'];
        $this->display();
    }

    public function post(){
        $this->fieldText['title'] = '新闻标题';
        ...
        if(IS_POST){
            ...
            $time = time();
              ...
              //自定义字段
            $data['field'] = postField('article',$this);
            ...
            $this->success("操作成功",U("Article/index",array('type'=>'article')));
        ...
        //获取分类
        $this->category = $category = getCateList("article");
    ...
    public function delete_all(){
        if(IS_POST){
            ...
            $rs = M($this->model)->where("id in(".$ids.")  and type='article'")->delete();
